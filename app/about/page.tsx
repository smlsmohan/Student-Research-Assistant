    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="text-center mb-12">
          <Badge className="mb-4 bg-blue-100 text-blue-700">About ResearchPath</Badge>
          <h1 className="text-4xl font-bold text-slate-900 mb-4">How We Help You Find Research Opportunities</h1>
          ...
          <CardContent className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-4">
                <h3 className="font-semibold text-slate-900">Official EU Databases</h3>
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <p className="text-sm text-slate-600">Our systems check for new opportunities every 6 hours</p>
              </div>
              <div className="text-center">
                <Shield className="h-12 w-12 text-green-600 mx-auto mb-4" />
                <h3 className="font-semibold mb-2">Quality Verification</h3>
                <p className="text-sm text-slate-600">Each opportunity is verified for accuracy and legitimacy</p>
              </div>
              <div className="text-center">
                <Award className="h-12 w-12 text-purple-600 mx-auto mb-4" />
                <h3 className="font-semibold mb-2">AI Matching</h3>
                <p className="text-sm text-slate-600">Advanced algorithms match opportunities to your profile</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="shadow-lg border-0 bg-white/80 backdrop-blur-sm mb-8">
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                <h3 className="font-semibold text-slate-900 mb-4">Research Opportunities</h3>
                <ul className="space-y-2 text-sm text-slate-600">
              ...
              <div>
                <h3 className="font-semibold text-slate-900 mb-4">Funding Information</h3>
                <ul className="space-y-2 text-sm text-slate-600">
              ...
              <div>
                <h3 className="font-semibold text-slate-900 mb-4">Researcher Profiles</h3>
                <ul className="space-y-2 text-sm text-slate-600">
              ...
              <div>
                <h3 className="font-semibold text-slate-900 mb-4">Market Insights</h3>
                <ul className="space-y-2 text-sm text-slate-600">
        ...
        <Card className="shadow-lg border-0 bg-white/80 backdrop-blur-sm mb-8">
          <CardHeader>
            ...
            <CardDescription>Your privacy is our priority. Learn how we protect your information</CardDescription>
          </CardHeader>
        ...
        <Card className="shadow-lg border-0 bg-white/80 backdrop-blur-sm">
          <CardHeader>
            ...
            <CardDescription>We're transparent about our methods and happy to answer your questions</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button variant="outline">Request Data Sources List</Button>
            </div>
          </CardContent>
        </Card>
      </div>
